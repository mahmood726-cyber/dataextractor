        # Dataextractor: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/dataextractor.git

        ## Objective

        DataExtractor provides automated extraction of statistical data from published clinical trial reports, supporting downstream meta-analysis and evidence synthesis.
        ...
        - Code: https://github.com/mahmood726-cyber/dataextractor.git
